...
describe('ObservationTable', () => {
  it('renders one row per observation in the given order', () => {
    render(
      <ObservationTable observations={[obs(1), obs(2)]} selectedId={null} onSelect={() => {}} />,
    );
  ...
  it('falls back to a truncated observer id when the name is missing', () => {
    render(
      <ObservationTable
        observations={[obs(1, { observerName: undefined, observerId: 'abcdefgh1234' })]}
        selectedId={null}
        onSelect={() => {}}
      />,
    );
  ...
  it('colors a null SNR as dim', () => {
    render(
      <ObservationTable
        observations={[obs(1, { snr: undefined })]}
        selectedId={null}
        onSelect={() => {}}
      />,
    );
