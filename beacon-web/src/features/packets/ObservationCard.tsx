  ...
  return (
    <div
      className={`bg-bg-base border border-border rounded px-3 py-2.5 border-l-2 transition-colors ${
        selected ? 'border-l-secondary bg-secondary/5' : 'border-l-primary'
      ...
      <div className="flex gap-5 font-mono text-xs">
        ...
        <div className="flex flex-col">
          ...
          <span className="font-medium text-text-normal">
            {formatPropagation(obs.propagationTimeMs)}
          </span>
        </div>
        <div className="flex flex-col">
          <span className="text-text-dim text-[10px] font-medium uppercase tracking-wider">
        ...
        <div className="flex items-center gap-1 mt-2 font-mono text-[11px] pt-1.5 border-t border-border-subtle">
          {isTrace ? (
            ...
            <>
              ...
              <PathData
                pathBytes={obs.pathBytes}
                hashSize={obs.pathLength.hashSize}
                resolvedPath={obs.resolvedPath}
                size="sm"
