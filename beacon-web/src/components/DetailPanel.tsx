...
export function DetailPanel({ title, onClose, collapsible, isLoading, notFound, notFoundIcon, notFoundLabel, headerAction, children }: DetailPanelProps) {
  ...
  return (
    <div className={`${minimized ? "absolute inset-x-0 bottom-0" : "absolute inset-0"} z-30 w-full lg:static lg:inset-auto lg:z-auto lg:shrink-0 lg:w-[400px] lg:border-l border-border bg-bg-surface flex flex-col min-h-0 overflow-hidden`}>
