...
//
//	mockgen -source=db/sqlc/querier.go -destination=db/sqlc/mock/querier.go -package=mock
//
...
func (m *MockQuerier) GetRoutePlanGraph(ctx context.Context) ([]db.GetRoutePlanGraphRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRoutePlanGraph", ctx)
	ret0, _ := ret[0].([]db.GetRoutePlanGraphRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockQuerier) ListNodePathPackets(ctx context.Context, arg db.ListNodePathPacketsParams) ([]db.ListNodePathPacketsRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListNodePathPackets", ctx, arg)
	ret0, _ := ret[0].([]db.ListNodePathPacketsRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
